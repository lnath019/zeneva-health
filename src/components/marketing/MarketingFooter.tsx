...
const SOCIAL_LINKS = [
  {
    label: 'WhatsApp',
    href: 'https://api.whatsapp.com/send?phone=9779810099853',
    external: true,
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/zenivahealthcare',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/zenivahealthcareclinic/',
    icon: (
    ...
    <footer className="bg-slate-900 text-slate-300">
      <div className="w-[95%] max-w-none mx-auto py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li>
              <a href="tel:+9779810099853" className="hover:text-white transition-colors">
                +977 9810099853 <span className="text-slate-500">(Phone / WhatsApp)</span>
              </a>
            </li>
            <li>
              <a href="tel:+97715927435" className="hover:text-white transition-colors">
                +977-1-5927435
              </a>
            </li>
            <li>
